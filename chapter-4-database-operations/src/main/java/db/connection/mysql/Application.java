...
public class Application {
	...
	public static void listActiveManagers(ManagerService managerService) {
		...
		List<Manager> allManager = managerService.allActiveManagers();
		System.out.println("Aktif y�neticiler");
		for (Manager manager : allManager) {
			System.out.println("Ad�: "+manager.getEmployee().getName()+" departman�: "+ manager.getDepartmentName());
		}
	}
	...
	public static void listDepartments(DepartmentService departmentService) {
		...
		List<Department> allDepart = departmentService.listAll();;
		System.out.println("T�m Departmanlar");
		for (Department department : allDepart) {
